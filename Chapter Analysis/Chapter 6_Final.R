...
#Dem
      dd [pos = '-4,8!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.75</b> <br/> <font color='black'> High=<i>0.60</i> </font> >]
      dld [pos = '-1.85,8!', label = 'LD',  fontsize=20, xlabel=<<b>0.17</b> <br/> <font color='black'> <i>0.18</i> </font> >]
      di [pos = '0, 8!',  label = 'Ind',  fontsize=20,  xlabel=<<b>0.03</b> <br/> <font color='black'> <i>0.06</i> </font> >]
      dlr [pos = '1.85, 8!', label = 'LR',  fontsize=20,  xlabel=<<b>0.03</b> <br/> <font color='black'> <i>0.09</i> </font> >]
      dr [pos = '4, 8!', label = 'Rep',  fontsize=20, xlabel=<<b>0.03</b> <br/> <font color='black'> <i>0.08</i> </font> >]

#Lean Dem
      ldd [pos = '-4,5!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.42</b> <br/> <font color='black'> High=<i>0.45</i> </font> >]
      ldld [pos = '-1.85,5!', label = 'LD',  fontsize=20, xlabel=<<b>0.30</b> <br/> <font color='black'> <i>0.17</i> </font> >]
      ldi [pos = '0,5!', label = 'Ind',  fontsize=20, xlabel=<<b>0.07</b> <br/> <font color='black'> <i>0.06</i> </font> >]
      ldlr [pos = '1.85,5!', label = 'LR',  fontsize=20, xlabel=<<b>0.09</b> <br/> <font color='black'> <i>0.12</i> </font> >]
      ldr [pos = '4,5!', label = 'Rep',  fontsize=20, xlabel=<<b>0.12</b> <br/> <font color='black'> <i>0.19</i> </font> >]
      
#Independent

      id [pos = '-4,2!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.26</b> <br/> <font color='black'> High=<i>0.40</i> </font> >]
      ild [pos = '-1.85,2!', label = 'LD',  fontsize=20, xlabel=<<b>0.27</b> <br/> <font color='black'> <i>0.17</i> </font> >]
      ii [pos = '0, 2!',  label = 'Ind',  fontsize=20, xlabel=<<b>0.09</b> <br/> <font color='black'> <i>0.06</i> </font> >]
      ilr [pos = '1.85, 2!',  label = 'LR',  fontsize=20, xlabel=<<b>0.12</b> <br/> <font color='black'> <i>0.13</i> </font> >]
      ir [pos = '4, 2!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.25</b> <br/> <font color='black'> <i>0.24</i> </font> >]
      
#LR

      lrd [pos = '-4,-1!', label = 'Dem',  fontsize=20,xlabel=<Low=<b>0.19</b> <br/> <font color='black'> High=<i>0.22</i> </font> >]
      lrld [pos = '-1.85,-1!', label = 'LD',  fontsize=20, xlabel=<<b>0.25</b> <br/> <font color='black'> <i>0.12</i> </font> >]
      lri [pos = '0, -1!',  label = 'Ind',  fontsize=20, xlabel=<<b>0.09</b> <br/> <font color='black'> <i>0.05</i> </font> >]
      lrlr [pos = '1.85, -1!',  label = 'LR',  fontsize=20, xlabel=<<b>0.14</b> <br/> <font color='black'> <i>0.14</i> </font> >]
      lrr [pos = '4, -1!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.33</b> <br/> <font color='black'> <i>0.47</i> </font> >]
      
#Rep

      rd [pos = '-4,-4!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.06</b> <br/> <font color='black'> High=<i>0.04</i> </font> >]
      rld [pos = '-1.85,-4!', label = 'LD',  fontsize=20, xlabel=<<b>0.15</b> <br/> <font color='black'> <i>0.04</i> </font> >]
      ri [pos = '0, -4!',  label = 'Ind',  fontsize=20,xlabel=<<b>0.08</b> <br/> <font color='black'> <i>0.02</i> </font> >]
      rlr [pos = '1.85, -4!',  label = 'LR',  fontsize=20,xlabel=<<b>0.15</b> <br/> <font color='black'> <i>0.11</i> </font> >]
      rr [pos = '4, -4!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.57</b> <br/> <font color='black'> <i>0.78</i> </font> >]
...
auth<-
  grViz("
        ...
        it1 [pos =  '0, 4!', label = 'Pure Independent\n(t-1)', fontsize=20]
        #Dem
        dd [pos = '-4,8!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.85</b> <br/> <font color='black'> High=<i>0.59</i> </font> >]
        dld [pos = '-1.85,8!', label = 'LD',  fontsize=20, xlabel=<<b>0.14</b> <br/> <font color='black'> <i>0.07</i> </font> >]
        di [pos = '0, 8!',  label = 'Ind',  fontsize=20,  xlabel=<<b>0.01</b> <br/> <font color='black'> <i>0.05</i> </font> >]
        dlr [pos = '1.85, 8!', label = 'LR',  fontsize=20,  xlabel=<<b>0.01</b> <br/> <font color='black'> <i>0.18</i> </font> >]
        dr [pos = '4, 8!', label = 'Rep',  fontsize=20, xlabel=<<b>0.01</b> <br/> <font color='black'> <i>0.12</i> </font> >]
        
        #Lean Dem
        ldd [pos = '-4,5!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.26</b> <br/> <font color='black'> High=<i>0.43</i> </font> >]
        ldld [pos = '-1.85,5!', label = 'LD',  fontsize=20, xlabel=<<b>0.57</b> <br/> <font color='black'> <i>0.06</i> </font> >]
        ldi [pos = '0,5!', label = 'Ind',  fontsize=20, xlabel=<<b>0.04</b> <br/> <font color='black'> <i>0.05</i> </font> >]
        ldlr [pos = '1.85,5!', label = 'LR',  fontsize=20, xlabel=<<b>0.09</b> <br/> <font color='black'> <i>0.21</i> </font> >]
        ldr [pos = '4,5!', label = 'Rep',  fontsize=20, xlabel=<<b>0.04</b> <br/> <font color='black'> <i>0.25</i> </font> >]
        
        #Independent
        
        id [pos = '-4,2!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.03</b> <br/> <font color='black'> High=<i>0.21</i> </font> >]
        ild [pos = '-1.85,2!', label = 'LD',  fontsize=20, xlabel=<<b>0.12</b> <br/> <font color='black'> <i>0.04</i> </font> >]
        ii [pos = '0, 2!',  label = 'Ind',  fontsize=20, xlabel=<<b>0.14</b> <br/> <font color='black'> <i>0.06</i> </font> >]
        ilr [pos = '1.85, 2!',  label = 'LR',  fontsize=20, xlabel=<<b>0.39</b> <br/> <font color='black'> <i>0.25</i> </font> >]
        ir [pos = '4, 2!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.32</b> <br/> <font color='black'> <i>0.44</i> </font> >]
        
        #LR
        
        lrd [pos = '-4,-1!', label = 'Dem',  fontsize=20,xlabel=<Low=<b>0.03</b> <br/> <font color='black'> High=<i>0.20</i> </font> >]
        lrld [pos = '-1.85,-1!', label = 'LD',  fontsize=20, xlabel=<<b>0.11</b> <br/> <font color='black'> <i>0.04</i> </font> >]
        lri [pos = '0, -1!',  label = 'Ind',  fontsize=20, xlabel=<<b>0.14</b> <br/> <font color='black'> <i>0.06</i> </font> >]
        lrlr [pos = '1.85, -1!',  label = 'LR',  fontsize=20, xlabel=<<b>0.39</b> <br/> <font color='black'> <i>0.25</i> </font> >]
        lrr [pos = '4, -1!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.34</b> <br/> <font color='black'> <i>0.45</i> </font> >]
        
        #Rep
        
        rd [pos = '-4,-4!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.01</b> <br/> <font color='black'> High=<i>0.03</i> </font> >]
        rld [pos = '-1.85,-4!', label = 'LD',  fontsize=20, xlabel=<<b>0.02</b> <br/> <font color='black'> <i>0.01</i> </font> >]
        ri [pos = '0, -4!',  label = 'Ind',  fontsize=20,xlabel=<<b>0.06</b> <br/> <font color='black'> <i>0.02</i> </font> >]
        rlr [pos = '1.85, -4!',  label = 'LR',  fontsize=20,xlabel=<<b>0.17</b> <br/> <font color='black'> <i>0.08</i> </font> >]
        rr [pos = '4, -4!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.74</b> <br/> <font color='black'> <i>0.86</i> </font> >]
...
a<-ggcorrplot(p1, lab=TRUE, type="full", method="circle", tl.col="blue",
           ...
           title="Non-Authoritarian", tl.srt = 45,  tl.cex=13, lab_size=5)
b<-ggcorrplot(p2, lab=TRUE, type="full", method="circle",
              ggtheme = ggplot2::theme_gray, show.legend = FALSE,
              title="Non-Authoritarian", tl.srt = 45,   tl.cex=13, lab_size=5)
c<-ggcorrplot(p4, lab=TRUE, type="full", method="circle",
              ggtheme = ggplot2::theme_gray, show.legend = FALSE,
              title="Authoritarian", tl.srt = 45 ,  tl.cex=13, lab_size=5)
...
auth<-
  grViz("
        ...
        it1 [pos =  '0, 4!', label = 'Pure Independent\n(t-1)', fontsize=20]
        #Dem
        dd [pos = '-4,8!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.88</b> <br/> <font color='black'> High=<i>0.74</i> </font> >]
        dld [pos = '-1.85,8!', label = 'LD',  fontsize=20, xlabel=<<b>0.08</b> <br/> <font color='black'> <i>0.06</i> </font> >]
        di [pos = '0, 8!',  label = 'Ind',  fontsize=20,  xlabel=<<b>0.03</b> <br/> <font color='black'> <i>0.12</i> </font> >]
        dlr [pos = '1.85, 8!', label = 'LR',  fontsize=20,  xlabel=<<b>0.01</b> <br/> <font color='black'> <i>0.06</i> </font> >]
        dr [pos = '4, 8!', label = 'Rep',  fontsize=20, xlabel=<<b>0.01</b> <br/> <font color='black'> <i>0.02</i> </font> >]
        
        #Lean Dem
        ldd [pos = '-4,5!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.42</b> <br/> <font color='black'> High=<i>0.23</i> </font> >]
        ldld [pos = '-1.85,5!', label = 'LD',  fontsize=20, xlabel=<<b>0.26</b> <br/> <font color='black'> <i>0.05</i> </font> >]
        ldi [pos = '0,5!', label = 'Ind',  fontsize=20, xlabel=<<b>0.25</b> <br/> <font color='black'> <i>0.32</i> </font> >]
        ldlr [pos = '1.85,5!', label = 'LR',  fontsize=20, xlabel=<<b>0.06</b> <br/> <font color='black'> <i>0.27</i> </font> >]
        ldr [pos = '4,5!', label = 'Rep',  fontsize=20, xlabel=<<b>0.07</b> <br/> <font color='black'> <i>0.14</i> </font> >]
        
        #Independent
        
        id [pos = '-4,2!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.10</b> <br/> <font color='black'> High=<i>0.05</i> </font> >]
        ild [pos = '-1.85,2!', label = 'LD',  fontsize=20, xlabel=<<b>0.16</b> <br/> <font color='black'> <i>0.04</i> </font> >]
        ii [pos = '0, 2!',  label = 'Ind',  fontsize=20, xlabel=<<b>0.48</b> <br/> <font color='black'> <i>0.34</i> </font> >]
        ilr [pos = '1.85, 2!',  label = 'LR',  fontsize=20, xlabel=<<b>0.19</b> <br/> <font color='black'> <i>0.35</i> </font> >]
        ir [pos = '4, 2!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.08</b> <br/> <font color='black'> <i>0.22</i> </font> >]
        
        #LR
        
        lrd [pos = '-4,-1!', label = 'Dem',  fontsize=20,xlabel=<Low=<b>0.02</b> <br/> <font color='black'> High=<i>0.01</i> </font> >]
        lrld [pos = '-1.85,-1!', label = 'LD',  fontsize=20, xlabel=<<b>0.05</b> <br/> <font color='black'> <i>0.02</i> </font> >]
        lri [pos = '0, -1!',  label = 'Ind',  fontsize=20, xlabel=<<b>0.25</b> <br/> <font color='black'> <i>0.18</i> </font> >]
        lrlr [pos = '1.85, -1!',  label = 'LR',  fontsize=20, xlabel=<<b>0.35</b> <br/> <font color='black'> <i>0.35</i> </font> >]
        lrr [pos = '4, -1!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.32</b> <br/> <font color='black'> <i>0.44</i> </font> >]
        
        #Rep
        
        rd [pos = '-4,-4!', label = 'Dem',  fontsize=20, xlabel=<Low=<b>0.01</b> <br/> <font color='black'> High=<i>0.01</i> </font> >]
        rld [pos = '-1.85,-4!', label = 'LD',  fontsize=20, xlabel=<<b>0.01</b> <br/> <font color='black'> <i>0.01</i> </font> >]
        ri [pos = '0, -4!',  label = 'Ind',  fontsize=20,xlabel=<<b>0.04</b> <br/> <font color='black'> <i>0.02</i> </font> >]
        rlr [pos = '1.85, -4!',  label = 'LR',  fontsize=20,xlabel=<<b>0.13</b> <br/> <font color='black'> <i>0.06</i> </font> >]
        rr [pos = '4, -4!',  label = 'Rep',  fontsize=20, xlabel=<<b>0.82</b> <br/> <font color='black'> <i>0.92</i> </font> >]
...
plot.2012<-
  grViz("
        ...
        dr [pos = '2, 1!', label = 'Republican',  fontsize=20, xlabel=<<b>0.05</b> <br/> <font color='black'> <i>0.29</i> </font> >]
        
        #Rep
        rd [pos = '-2,-2!', label = 'Democratic',  fontsize=20, xlabel=<Low=<b>0.10</b> <br/> <font color='black'> High=<i>0.02</i> </font> >]
        rr [pos = '2, -2!',  label = 'Republican',  fontsize=20, xlabel=<<b>0.90</b> <br/> <font color='black'> <i>0.98</i> </font> >]
...
ggplot( aes(x=t1, y=transition, 
  ...
  theme(axis.text.x=element_text(size=10,colour="#535353", angle=55, vjust=1, hjust=1)) +
  ...
  ggtitle("PID by age cohort. Authoritarian White Respondents") 
